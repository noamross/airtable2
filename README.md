...
`air_demo()` gives you a quick interactive tour of features once you have credentials set up.
It requires a token and a Workspace ID where it will set up a demonstration Airtable.
...
See the [Getting Started vignette](https://noamross.github.io/airtable2/articles/airtable2.html)
